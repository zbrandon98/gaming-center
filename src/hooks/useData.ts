...
const useData = <T>(endpoint: string, requestConfig?: AxiosRequestConfig, deps?: any[]) => {
    ...
    useEffect(() => {
        ...
        setIsLoading(true)
        apiClient.get<FetchResponse<T>>(endpoint, {signal: controller.signal, ...requestConfig})  //sends request to base url + /games and requires object form FetchGamesResponse
          .then((result) => {
